...
public class GeolocalizatedNotification: NSObject, CLLocationManagerDelegate {
    ...
    public func notificateWhenInLocation(latitude: Double, longitude: Double, radius: Double, identifier: String) {
        ...
        setupLocation(latitude: latitude, longitude: longitude, radius: radius, identifier: identifier)
    }
    
    

    private func setupLocation(latitude: Double , longitude: Double, radius: Double, identifier: String) {
